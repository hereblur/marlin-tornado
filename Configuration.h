...
#define STRING_CONFIG_H_AUTHOR "(Chocball, V2 Tornado)"  // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Chocball"           // will be shown during bootup in line 1
...
#define MESH_TEST_HOTEND_TEMP  180.0  // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
